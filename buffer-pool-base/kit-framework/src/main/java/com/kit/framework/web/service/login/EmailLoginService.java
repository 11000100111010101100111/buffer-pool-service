...
@Service
public class EmailLoginService extends AbstractLoginService {
    @Autowired
    ...
    private void checkUserIfExists(String username) {
        SysUser sysUser = userService.selectUserByEmail(username);
    ...
    public AbstractAuthenticationToken getAuthenticationToken(LoginBody loginBody) {
        return new EmailAuthentication(loginBody.getUsername(), loginBody.getCode());
    }
}
