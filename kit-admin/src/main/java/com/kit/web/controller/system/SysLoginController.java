...
import com.kit.framework.web.service.SysLoginService;
...
public class SysLoginController
{
    ...
    public AjaxResult login(@RequestBody LoginBody loginBody)
    {
        ...
        // 生成令牌
        SysLoginService.LoginInfo loginInfo = loginService.login(loginBody.getUsername(), loginBody.getPassword(), loginBody.getCode(),
                loginBody.getUuid());
